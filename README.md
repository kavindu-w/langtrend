...
_Judged with (mixed — fallback used):_ `google/gemma-4-31b-it:free` (291), `z-ai/glm-5.2:free` (202), `google/gemma-4-26b-a4b-it:free` (153)
...
| Unique languages detected | 105 | 433 |
