...
[![LangTrend Snapshot](https://github.com/kavindu-w/langtrend/actions/workflows/langtrend.yml/badge.svg)](https://github.com/kavindu-w/langtrend/actions/workflows/langtrend.yml) [![Tests](https://github.com/kavindu-w/langtrend/actions/workflows/tests.yml/badge.svg)](https://github.com/kavindu-w/langtrend/actions/workflows/tests.yml) [![Coverage (Python)](https://img.shields.io/codecov/c/github/kavindu-w/langtrend/main?flag=python&label=codecov%20python&logo=codecov&logoColor=white)](https://codecov.io/gh/kavindu-w/langtrend) [![Coverage (Web)](https://img.shields.io/codecov/c/github/kavindu-w/langtrend/main?flag=web&label=codecov%20web&logo=codecov&logoColor=white)](https://codecov.io/gh/kavindu-w/langtrend) [![Release](https://img.shields.io/github/v/release/kavindu-w/langtrend?sort=semver)](https://github.com/kavindu-w/langtrend/releases) [![Website](https://img.shields.io/website?url=https%3A%2F%2Fkavindu-w.github.io%2Flangtrend&label=live%20site)](https://kavindu-w.github.io/langtrend) [![Papers Analysed](https://img.shields.io/endpoint?url=https%3A%2F%2Fraw.githubusercontent.com%2Fkavindu-w%2Flangtrend%2Fmain%2Fdata%2Fprocessed%2Fbadges%2Fpapers_badge.json)](https://kavindu-w.github.io/langtrend) [![Languages Tracked](https://img.shields.io/endpoint?url=https%3A%2F%2Fraw.githubusercontent.com%2Fkavindu-w%2Flangtrend%2Fmain%2Fdata%2Fprocessed%2Fbadges%2Flanguages_badge.json)](https://kavindu-w.github.io/langtrend) [![License: CC BY-NC 4.0](https://img.shields.io/badge/License-CC%20BY--NC%204.0-lightgrey.svg)](https://creativecommons.org/licenses/by-nc/4.0/) [![GitHub last commit](https://img.shields.io/github/last-commit/kavindu-w/langtrend)](https://github.com/kavindu-w/langtrend/commits/main) [![GitHub issues](https://img.shields.io/github/issues/kavindu-w/langtrend)](https://github.com/kavindu-w/langtrend/issues) [![GitHub pull requests](https://img.shields.io/github/issues-pr/kavindu-w/langtrend)](https://github.com/kavindu-w/langtrend/pulls)
...
_Latest processed week: **2026-06-22 – 2026-06-29**._
...
**LLM judge setup** — copy `.env.example` to `.env` and set `LLM_JUDGE_API_KEY` (free key from [console.groq.com](https://console.groq.com)). The judge only calls the model for papers that already have regex detections, one request per paper, throttled to the free-tier rate limit; re-runs skip papers with cached verdicts in `data/processed/weeks/<week>/judge_cache/`. For quota-free local testing, point `LLM_JUDGE_BASE_URL` at an Ollama server (see `.env.example`). Test single papers with:
...
6. Build the Astro site and deploy to GitHub Pages — **only if every week's papers are fully judged** (a repo-wide check, not just this week)

Since the LLM judge's free-tier quota doesn't always cover a full week in one run (see `judge_languages.py`'s `--sweep-all-weeks`/`--check-only` modes), a second workflow at `.github/workflows/judge-catchup.yml` runs **daily**, retrying whatever's still pending across every week (oldest first) and building/deploying the site once the backlog is fully cleared. It shares the same `deploy` concurrency group as the weekly pipeline, so GitHub Actions queues it behind that pipeline automatically rather than running the two concurrently. `.github/workflows/deploy.yml` is a small reusable workflow shared by both.
