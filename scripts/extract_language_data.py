...
_POSSIBLE_FALSE_POSITIVE_LANGUAGES: dict[str, str] = {
    ...
    "Aisi":     "AISI = AI Safety Institute (UK) — common in AI safety papers",
    "Cora":     "CORA = citation network benchmark dataset — common in GNN/graph learning papers",
    "Cua":      "CUA = Computer Use Agent (Anthropic/Claude) — common in agentic AI papers",
    "Dao":      "Possible false positive",
    ...
    "Ega":      "EGA = Energy-Gated Attention — method name acronym in vision/NLP papers",
    ...
    "Lama":     "LAMA = Fast Downward AI planning algorithm; distinct from LLaMA language model",
    ...
    "Loo":      "LOO = Leave-One-Out cross-validation — standard ML evaluation acronym",
    ...
    "Mer":      "MER = Mars Exploration Rover or Mean Error Rate — scientific/NLP acronym",
    "Picard":   "Picard = text-to-SQL semantic parsing model (ICLR 2022) — common in NL-to-SQL papers",
    "Sake":     "English word 'sake' in 'for the sake of' — common academic phrase, not a language",
    "Samba":    "Samba = hybrid SSM-attention architecture acronym in LLM efficiency papers",
    ...
    "Sora":     "Sora = OpenAI video generation model; SoRA = Sparse LoRA — common model names",
    ...
    "Wanda":    "Wanda = unstructured weight pruning method — common in model compression papers",
    ...
    # Short/generic words that match many common English terms or are author/place names
    "Batu":     "Possible false positive",
    "Beaver":   "English word 'beaver' (animal) — appears as animal name in corpora, not a language name",
    "Crow": "Crow is a Missouri Valley Siouan language , but can also matches bird keyword lists in corpus studies",
    ...
    "Fur": "Fur is a Nilo-Saharan language, but can also matches with 'hair' or matches 'further', 'furniture', etc.",
    "Ik":       "Possible false positive",
    "Logo":     "English word 'logo' (brand/symbol) — appears in multimodal/advertising papers",
    "Mon":      "Too short/generic — matches 'monitor', 'month', 'Monday', etc.",
    "Nasal":    "Linguistic term 'nasal consonant' — not a language name; appears in phonology papers",
    "Noon":     "English word 'noon' (midday) — appears in time/scheduling task datasets",
    "Mo":       "Too short — matches many common words and abbreviations",
    "Pin":      "Too short/generic — matches many common words",
    "Pol":      "Matches 'polarity' prefix in sentiment analysis papers (polarization, political, etc.)",
    "Pole":     "Often matches mathematical 'poles' in geometry/embeddings papers",
    "Sar":      "SAR = Synthetic Aperture Radar or Segment-And-Recombine — common in vision/speech papers",
    ...
    "Duke": "Possible false positive — Duke University; Duke is also a real language",
    ...
    "Sop":      "SOP = Standard Operating Procedure — very common acronym in agentic AI / agent-workflow papers",
        "Zay": "Possible false positive",
        "Bun": "Possible false positive",
        "Geez": "Ge'ez is a ancient South Semitic language , but 'geez' (lowercase) is also a common informal English exclamation that appears in dialogue, social media, and conversational datasets",
        "Ashe": "Possible false positive",
        "Tulu": "Possible false positive",
    "Tera":     "\\tera = SI prefix for 10^12 (terabytes, teraflops) — arXiv ltx_ERROR span leaks \\tera as plain text",
        "Chong": "Possible false positive",
        ...
        "Hehe": "Hehe is a Bantu language , but  is also a common informal English exclamation that appears in dialogue, social media, and conversational datasets",
        
        "Abu": "Possible false positive",
        "Maya": "Possible false positive - could match a Model name",
