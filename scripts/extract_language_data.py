...
_POSSIBLE_FALSE_POSITIVE_LANGUAGES: dict[str, str] = {
    ...
    "Bo":       "BO = Bayesian Optimization (GP-BO); also a Chinese given name in author lists",
    ...
    "Fur":      "Likely matches 'further', 'furniture', etc.",
    ...
    "Puri":     "Common personal name (e.g. Puri et al.) surviving citation cleaning",
